...
namespace Unity.LEGO.Minifig
{
    public class MinifigController : MonoBehaviour
    {
        ...
        public TurnTarget currentTurnTarget;
        public State state;
                ...
                case State.Following:
                    {
                        ...
                        {
                            Vector3 direction;
                            if( currentFollowTarget.tgt != null )
                            {
                                direction = currentFollowTarget.tgt - transform.position;
                            } else {
                                direction = currentFollowTarget.target.position - transform.position;
                            }
        ...
        public void Follow2(Vector3 tgt, float minDistance = 0.0f, Action onComplete = null, float onCompleteDelay = 0.0f,
            float followDelay = 0.0f, bool cancelSpecial = true, float speedMultiplier = 1.0f, float rotationSpeedMultiplier = 1.0f, Vector3? turnToWhileCompleting = null)
        {
            FollowTarget followTarget = new FollowTarget()
            {
        ...
        public void TurnToDirection(Vector3 direction, float minAngle, float rotationSpeedMultiplier, bool cancelSpecial)
        {
